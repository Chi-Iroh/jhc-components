...
defaultPlatformProject.pkgs.lib.mapAttrs (_: pkgs: rec {
  ...
  jhc-components = import ./default.nix { nativePkgs = pkgs;
                                     customModules = [ { packages.jhc-components.jhc-app.dontStrip = false; } ] ++ (if pkgs.stdenv.hostPlatform.isMusl then 
                                                        [
                                                          ...
                                                          { packages.jhc-components.jhc-app.configureFlags = 
                                                            [
