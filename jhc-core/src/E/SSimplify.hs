...
instance Semigroup Forced where
    (<>) NotForced x = x
    (<>) x NotForced = x
    (<>) _ ForceNoinline = ForceNoinline
    (<>) ForceNoinline _ = ForceNoinline
    (<>) ForceInline ForceInline = ForceInline
...
instance Semigroup Env where
    (Env aa ab ac ad ae) <> (Env aa' ab' ac' ad' ae') = Env (mappend aa aa')(mappend ab ab')(mappend ac ac')(mappend ad ad')(mappend ae ae')
