...
newtype S a = S (RWS SEnv SCol SState a)
    deriving(Monad,Functor,MonadWriter SCol, MonadReader SEnv,MonadState SState,Applicative)
...
instance Semigroup SEnv where
    (<>) (SEnv aa ab ac) (SEnv aa' ab' ac') = SEnv (mappend aa aa')(mappend ab ab')(mappend ac ac')

instance Monoid SCol where
    mempty = SCol mempty mempty

instance Semigroup SCol where
    (<>) (SCol aa ab) (SCol aa' ab') = SCol (mappend aa aa')(mappend ab ab')
